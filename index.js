...
function calculateTotal() {
    ...
    const numberOfTickets = parseInt(document.getElementById('ticket-seat').innerText);
...
submitButton.addEventListener('click', function () {
    ...
    if (!passengerName.match(/^[a-zA-Z\s]+$/)) {
        alert('Please enter a valid passenger name. Only letters and spaces are allowed.');
